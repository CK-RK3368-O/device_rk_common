...
PRODUCT_COPY_FILES += \
    ...
    $(call add-to-product-copy-files-if-exists,device/rockchip/common/init.$(TARGET_BOARD_HARDWARE).bootmode.nand.rc:root/init.$(TARGET_BOARD_HARDWARE).bootmode.nand.rc) \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/preinstall.sh:vendor/bin/preinstall.sh
